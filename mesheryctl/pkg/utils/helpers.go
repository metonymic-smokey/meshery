...
const (
	...
	baseConfigURL  = "https://raw.githubusercontent.com/layer5io/meshery-operator/"
	OperatorURL    = "/config/manifests/default.yaml"
	BrokerURL      = "/config/samples/meshery_v1alpha1_broker.yaml"
	MeshsyncURL    = "/config/samples/meshery_v1alpha1_meshsync.yaml"
)
